...
public class ViewHolderUserPrimary extends RecyclerView.ViewHolder implements OnClickListener{
	...
	public ViewHolderUserPrimary(View view, IExpenseGroupClickListener clickListener) {
		super(view);
