...
public class ViewHolderCategorySecondary extends RecyclerView.ViewHolder implements OnClickListener{
	...
	public ViewHolderCategorySecondary(View view, IExpenseGroupClickListener clickListener) {
		super(view);
