...
public class PushUserExpensesService extends PushService<UserExpenseDTO, Long, PushLongResponse> {

	private static final String TAG = PushUserExpensesService.class.getSimpleName();

	List<UserExpense> userExpenseList = null;

	public PushUserExpensesService() {
		super(TAG);
	}
