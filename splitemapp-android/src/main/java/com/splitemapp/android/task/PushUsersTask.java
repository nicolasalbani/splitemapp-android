 ...
 * @author nicolas
 */
public class PushUsersTask extends PushTask<UserDTO, Long, PushLongResponse> {
	
	public PushUsersTask(DatabaseHelper databaseHelper, RestfulFragment restfulFragment) {
